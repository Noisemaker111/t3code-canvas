...
//     reconciler's reconcile. No swap, no rollback, primary stays up.
...
//      split, DesktopWslBackend reconciler, new IPC, web compat.
...
// refuses overwrites so two independent reconcilers racing on the
...
// reconcilers that build their own specs can confirm the layer graph
