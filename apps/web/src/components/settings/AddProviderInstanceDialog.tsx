                      ...
                      <RadioPrimitive.Root
                        ...
                        className={cn(
                          ...
                          isSelected
                            ...
                            : "border-bg-raised hover:border-foreground/20 hover:bg-muted/50",
                        )}
                      >
                  ...
                  {COMING_SOON_DRIVER_OPTIONS.map((option) => {
                    ...
                    return (
                      <RadioPrimitive.Root
                        ...
                        disabled
                        className={cn(
                          "relative flex cursor-not-allowed items-center gap-3 rounded-lg border border-bg-raised px-3 py-3 text-left opacity-55 outline-none",
                        )}
                      >
                        <IconComponent
