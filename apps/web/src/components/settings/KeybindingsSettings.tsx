...
function WhenExpressionNodeEditor({
  ...
  if (condition) {
    ...
    return (
      <div className="flex items-center gap-2 rounded-md bg-raised/60 px-2 py-2">
        <Toggle
  ...
  if (node.type === "not") {
    return (
      <div
        className={cn(
          "space-y-2 rounded-lg bg-raised p-2",
...
export function KeybindingsSettingsPanel({ embedded = false }: { embedded?: boolean } = {}) {
