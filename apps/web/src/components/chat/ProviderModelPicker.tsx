...
import { ModelPickerContent, type AutoModelOption } from "./ModelPickerContent";
...
export const ProviderModelPicker = memo(function ProviderModelPicker(props: {
  ...
  /** Board contexts add "Auto Router" here; threads leave it out. */
  ...
  const autoSelected = props.autoOption?.selected === true;
  ...
  const triggerLabel = autoSelected
    ? (props.autoOption!.description ?? props.autoOption!.label)
    : selectedModel
    ...
    >
      ...
      >
        <span className="flex min-w-0 flex-1 items-center gap-2">
          {autoSelected ? (
            <ShuffleIcon aria-hidden="true" className="size-4 shrink-0" />
          ) : activeEntry ? (
      ...
      >
        <ModelPickerContent
          ...
          {...(props.autoOption ? { autoOption: props.autoOption } : {})}
