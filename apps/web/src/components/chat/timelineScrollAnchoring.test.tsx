...
describe("timeline scroll anchoring", () => {
  ...
  it("offsets scrollToEnd so the last row clears the docked composer", () => {
    expect(resolveComposerScrollToEndViewOffset(0)).toBe(0);
    expect(resolveComposerScrollToEndViewOffset(-12)).toBe(0);
    expect(resolveComposerScrollToEndViewOffset(Number.NaN)).toBe(0);
    expect(resolveComposerScrollToEndViewOffset(180)).toBe(-180);
    expect(resolveComposerScrollToEndViewOffset(144.2)).toBe(-145);
  });
});
