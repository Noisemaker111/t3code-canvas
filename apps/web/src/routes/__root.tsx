...
import { buildCrashReport, formatCrashReportForAgent, reportCrash } from "../crashReport";
...
import { ErrorLogIndicator, ErrorLogModal } from "../components/ui/errorLog";
import {
...
function RootRouteErrorView({ error, reset }: ErrorComponentProps) {
  const report = useMemo(() => buildCrashReport(error), [error]);
  ...
  return (
    <CrashScreen
      ...
      copyText={formatCrashReportForAgent(report)}
      onTryAgain={() => reset()}
