...
/**
 * Whether the primary server's settings have actually arrived, rather than
 * defaults standing in for them. Callers that must not act on a placeholder
 * value — the canvas licence, which tldraw only reads once — wait on this.
 */
