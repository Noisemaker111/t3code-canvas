...
import Migration0033 from "./Migrations/033_ConversationLogView.ts";
import Migration0034 from "./Migrations/034_KanbanCards.ts";
import Migration0035 from "./Migrations/035_BtwMessages.ts";
import Migration0036 from "./Migrations/036_SimplifyKanbanPipeline.ts";
import Migration0037 from "./Migrations/037_KanbanThreeColumnPrep.ts";
import Migration0038 from "./Migrations/038_KanbanDraftColumn.ts";
import Migration0039 from "./Migrations/039_KanbanCardProjectId.ts";
import Migration0040 from "./Migrations/040_KanbanCardModelSelection.ts";
import Migration0041 from "./Migrations/041_KanbanCardHistory.ts";
import Migration0042 from "./Migrations/042_KanbanCardArchivedAt.ts";
import Migration0043 from "./Migrations/043_HermesCardOperations.ts";
import Migration0044 from "./Migrations/044_CanvasDocuments.ts";
import Migration0045 from "./Migrations/045_CanvasAreas.ts";
import Migration0046 from "./Migrations/046_BaseBranchSelection.ts";
import Migration0047 from "./Migrations/047_KanbanCardAttachments.ts";
import Migration0048 from "./Migrations/048_KanbanCardPrIdentityAndColumnClock.ts";
import Migration0049 from "./Migrations/049_KanbanCardModelRouteReason.ts";
import Migration0050 from "./Migrations/050_DropCanvasAreas.ts";
import Migration0051 from "./Migrations/051_KanbanPrChecks.ts";
import Migration0052 from "./Migrations/052_CleanupStalePendingTurns.ts";
import Migration0053 from "./Migrations/053_SettleStaleStreamingMessages.ts";
...
export const migrationEntries = [
  ...
  [33, "ConversationLogView", Migration0033],
  [34, "KanbanCards", Migration0034],
  [35, "BtwMessages", Migration0035],
  [36, "SimplifyKanbanPipeline", Migration0036],
  [37, "KanbanThreeColumnPrep", Migration0037],
  [38, "KanbanDraftColumn", Migration0038],
  [39, "KanbanCardProjectId", Migration0039],
  [40, "KanbanCardModelSelection", Migration0040],
  [41, "KanbanCardHistory", Migration0041],
  [42, "KanbanCardArchivedAt", Migration0042],
  [43, "HermesCardOperations", Migration0043],
  [44, "CanvasDocuments", Migration0044],
  [45, "CanvasAreas", Migration0045],
  [46, "BaseBranchSelection", Migration0046],
  [47, "KanbanCardAttachments", Migration0047],
  [48, "KanbanCardPrIdentityAndColumnClock", Migration0048],
  [49, "KanbanCardModelRouteReason", Migration0049],
  [50, "DropCanvasAreas", Migration0050],
  [51, "KanbanPrChecks", Migration0051],
  [52, "CleanupStalePendingTurns", Migration0052],
  [53, "SettleStaleStreamingMessages", Migration0053],
] as const;
