...
const EnvServerConfig = Config.all({
  ...
  // Production packages normally discover dist/client beside bin.mjs. Keep an
  // explicit override for distro packages and deployments that install the web
  // bundle separately (and for the canvas package's immutable asset directory).
...
export const resolveServerConfig = (
  ...
  Effect.gen(function* () {
    ...
    const staticDir = devUrl
      ? undefined
      : (env.staticDir ?? (yield* ServerConfig.resolveStaticDir()));
