...
export const makeCodexTextGeneration = Effect.fn("makeCodexTextGeneration")(function* (
  ...
  const runCodexJson = Effect.fn("runCodexJson")(function* <S extends Schema.Top>({
    ...
    const runCodexCommand = Effect.fn("runCodexJson.runCodexCommand")(function* () {
      ...
      const slicedCommand = inAgentSlice(spawnCommand);
      const command = ChildProcess.make(slicedCommand.command, slicedCommand.args, {
        env: {
          ...resolvedEnvironment,
          ...(codexConfig.homePath ? { CODEX_HOME: expandHomePath(codexConfig.homePath) } : {}),
        },
        cwd,
        shell: slicedCommand.shell,
        stdin: {
  ...
  const assistPrompt: TextGeneration.TextGeneration["Service"]["assistPrompt"] = Effect.fn(
    "CodexTextGeneration.assistPrompt",
  )(function* (input) {
    ...
    } satisfies TextGeneration.PromptAssistGenerationResult;
  });
