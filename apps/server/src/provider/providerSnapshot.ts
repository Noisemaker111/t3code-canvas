...
// A CLI version probe is a cold Node/Bun start. Four seconds is a normal
// answer on an idle laptop and a timeout on a box already running agents, and
// a timed-out probe used to take the provider out of every model picker.
