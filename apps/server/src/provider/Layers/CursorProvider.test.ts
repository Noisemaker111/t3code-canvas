...
const cursorAcpDiscoveryFailedMessage = [
  ...
  "Check the Cursor CLI setup (https://cursor.com/docs/cli/installation), restart T3 Code, and try again.",
].join(" ");
const missingCursorBinaryPath = "/definitely/not/installed/t3-cursor-agent";
const cursorCliCommandMissingMessage = [
  `\`${missingCursorBinaryPath}\` is not on PATH.`,
  "Install the Cursor CLI, then restart T3 Code — https://cursor.com/docs/cli/installation.",
].join(" ");
