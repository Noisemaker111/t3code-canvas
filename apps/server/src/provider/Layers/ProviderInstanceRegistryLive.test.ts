...
const codexHomeKey = (home: string) => `codex:home:${NodePath.resolve(home)}`;
  ...
  it.live("boots two independent codex instances from a ProviderInstanceConfigMap", () =>
    Effect.gen(function* () {
      ...
      expect(personalSnapshot.continuation?.groupKey).toBe(
        codexHomeKey("/home/julius/.codex_personal"),
      );
      ...
      expect(workSnapshot.continuation?.groupKey).toBe(codexHomeKey("/home/julius/.codex"));
...
describe("ProviderInstanceRegistryLive — all drivers slice", () => {
  ...
  it.live("boots one instance of every shipped driver from a single config map", () =>
    Effect.gen(function* () {
      ...
      expect(codexSnapshot.continuation?.groupKey).toBe(codexHomeKey("/home/julius/.codex"));
