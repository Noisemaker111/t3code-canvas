...
export function createSourceControlEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    accountIdentity: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:server:source-control-account-identity",
      tag: WS_METHODS.serverGetSourceControlAccountIdentity,
    }),
