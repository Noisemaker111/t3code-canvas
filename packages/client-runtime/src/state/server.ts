...
export function createServerEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    kanbanCards: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:server:kanban-cards",
      tag: WS_METHODS.kanbanList,
    }),
    kanbanCreateCard: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:kanban-create-card",
      tag: WS_METHODS.kanbanCreateCard,
    }),
    kanbanUpdateCard: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:kanban-update-card",
      tag: WS_METHODS.kanbanUpdateCard,
    }),
    kanbanDeleteCard: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:kanban-delete-card",
      tag: WS_METHODS.kanbanDeleteCard,
    }),
    kanbanBoardControl: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:kanban-board-control",
      tag: WS_METHODS.kanbanBoardControl,
    }),
    kanbanLaunchActive: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:kanban-launch-active",
      tag: WS_METHODS.kanbanLaunchActive,
    }),
    kanbanOpenPr: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:kanban-open-pr",
      tag: WS_METHODS.kanbanOpenPr,
    }),
    kanbanMergePr: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:kanban-merge-pr",
      tag: WS_METHODS.kanbanMergePr,
    }),
    kanbanOpenPrs: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:server:kanban-open-prs",
      tag: WS_METHODS.kanbanListOpenPrs,
    }),
    kanbanOpenIssues: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:server:kanban-open-issues",
      tag: WS_METHODS.kanbanListOpenIssues,
    }),
    kanbanListCardHistory: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:kanban-list-card-history",
      tag: WS_METHODS.kanbanListCardHistory,
    }),
    kanbanAppendCardHistory: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:kanban-append-card-history",
      tag: WS_METHODS.kanbanAppendCardHistory,
    }),
    canvasDocument: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:server:canvas-document",
      tag: WS_METHODS.canvasGet,
    }),
    canvasSave: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:canvas-save",
      tag: WS_METHODS.canvasSave,
    }),
    canvasInjections: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:server:canvas-injections",
      tag: WS_METHODS.canvasListInjections,
    }),
    canvasAckInjections: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:canvas-ack-injections",
      tag: WS_METHODS.canvasAckInjections,
    }),
    canvasPostMessage: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:canvas-post-message",
      tag: WS_METHODS.canvasPostMessage,
    }),
    canvasMessages: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:server:canvas-messages",
      tag: WS_METHODS.canvasListMessages,
    }),
    promptAssist: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:prompt-assist",
      tag: WS_METHODS.promptAssist,
    }),
    updateState: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:server:update-state",
      tag: WS_METHODS.serverGetUpdateState,
    }),
    checkForUpdate: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:check-for-update",
      tag: WS_METHODS.serverCheckForUpdate,
    }),
    installUpdate: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:install-update",
      tag: WS_METHODS.serverInstallUpdate,
    }),
    vpsSnapshot: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:server:vps-snapshot",
      tag: WS_METHODS.vpsGetSnapshot,
    }),
    vpsServiceAction: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:vps-service-action",
      tag: WS_METHODS.vpsServiceAction,
    }),
    vpsSignalProcess: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:vps-signal-process",
      tag: WS_METHODS.vpsSignalProcess,
    }),
    vpsRunHealth: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:vps-run-health",
      tag: WS_METHODS.vpsRunHealth,
    }),
    vpsSetForgeToken: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:vps-set-forge-token",
      tag: WS_METHODS.vpsSetForgeToken,
    }),
  };
}
