...
export const GitRunStackedActionInput = Schema.Struct({
  ...
  /** What the work was launched to do. Context for generated commit/PR text. */
  mission: Schema.optional(TrimmedNonEmptyStringSchema.check(Schema.isMaxLength(4_000))),
