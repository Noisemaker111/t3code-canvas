...
/**
 * OpenAI/Codex defaults — only gpt-5.6-sol / gpt-5.6-luna (see docs/MODELS.context.md).
 * Never pin 5.4 / 5.5 / invented *-codex; use effort options for strength.
 */
...
export const DEFAULT_MODEL_BY_PROVIDER: Partial<Record<ProviderDriverKind, string>> = {
  ...
  [OPENCODE_DRIVER_KIND]: "openai/gpt-5.6-sol",
};
...
> = {
  ...
  [OPENCODE_DRIVER_KIND]: "openai/gpt-5.6-luna",
};
...
> = {
  [CODEX_DRIVER_KIND]: {
    // Retired / wrong pins → only sol|luna (docs/MODELS.context.md)
    ...
    "5.3-spark": "gpt-5.6-sol",
    "gpt-5.3-spark": "gpt-5.6-sol",
