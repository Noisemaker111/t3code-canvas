...
// sidebar.toggle / editor.openFavorite / thread.previous / thread.next /
// thread.jump.* have no mounted handler in any current build; the command ids
// stay valid so stored user bindings still decode, but they are not advertised
// as defaults.
