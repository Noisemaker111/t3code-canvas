...
describe("model slug normalization", () => {
  ...
  it("rewrites retired Codex pins to gpt-5.6-sol / luna", () => {
    const codex = ProviderDriverKind.make("codex");
    expect(normalizeModelSlug("gpt-5.4", codex)).toBe("gpt-5.6-sol");
    expect(normalizeModelSlug("gpt-5.4-mini", codex)).toBe("gpt-5.6-luna");
    expect(normalizeModelSlug("gpt-5.5", codex)).toBe("gpt-5.6-sol");
    expect(normalizeModelSlug("gpt-5.6-sol", codex)).toBe("gpt-5.6-sol");
  });
});
