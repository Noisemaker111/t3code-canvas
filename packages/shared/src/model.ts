...
import { resolveCodexBaseModel } from "./codexModelPolicy.ts";
...
export function normalizeModelSlug(
  ...
  // Codex: force sol|luna policy (docs/MODELS.context.md) — never leave retired pins.
  if (provider === CODEX_DRIVER) {
    return resolveCodexBaseModel(trimmed);
  }
...
/** Canonical thinking-effort ladder, cheapest first. Providers subset it. */
